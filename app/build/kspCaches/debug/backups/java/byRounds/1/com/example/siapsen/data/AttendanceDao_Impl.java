...
public final class AttendanceDao_Impl implements AttendanceDao {
  ...
  public AttendanceDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfAttendanceEntity = new EntityInsertionAdapter<AttendanceEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `attendance` (`id`,`username`,`nama`,`type`,`timestamp`,`photoPath`,`latitude`,`longitude`,`address`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp = __converters.fromAttendanceType(entity.getType());
  ...
  @Override
  public Object insert(final AttendanceEntity attendance,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      ...
      public Long call() throws Exception {
        ...
        try {
          final Long _result = __insertionAdapterOfAttendanceEntity.insertAndReturnId(attendance);
  ...
  @Override
  public Flow<List<AttendanceEntity>> getAll() {
      ...
      public List<AttendanceEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpType = __converters.toAttendanceType(_tmp);
            ...
            _item = new AttendanceEntity(_tmpId,_tmpUsername,_tmpNama,_tmpType,_tmpTimestamp,_tmpPhotoPath,_tmpLatitude,_tmpLongitude,_tmpAddress);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getLast(final AttendanceType type,
      final Continuation<? super AttendanceEntity> $completion) {
    final String _sql = "SELECT * FROM attendance WHERE type=? ORDER BY timestamp DESC LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    final String _tmp = __converters.fromAttendanceType(type);
      ...
      public AttendanceEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmpType = __converters.toAttendanceType(_tmp_1);
            final long _tmpTimestamp;
            _tmpTimestamp = _cursor.getLong(_cursorIndexOfTimestamp);
            final String _tmpPhotoPath;
            if (_cursor.isNull(_cursorIndexOfPhotoPath)) {
            ...
            _result = new AttendanceEntity(_tmpId,_tmpUsername,_tmpNama,_tmpType,_tmpTimestamp,_tmpPhotoPath,_tmpLatitude,_tmpLongitude,_tmpAddress);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getLastAttendance(final Continuation<? super AttendanceEntity> $completion) {
    final String _sql = "SELECT * FROM attendance ORDER BY timestamp DESC LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<AttendanceEntity>() {
      @Override
  ...
  @Override
  public Flow<List<AttendanceEntity>> getAllAttendance() {
    final String _sql = "SELECT * FROM attendance ORDER BY timestamp DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"attendance"}, new Callable<List<AttendanceEntity>>() {
      @Override
