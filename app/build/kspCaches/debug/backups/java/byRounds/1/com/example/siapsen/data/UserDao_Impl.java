...
public final class UserDao_Impl implements UserDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateNama;
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`username`,`password`,`nama`,`role`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdateNama = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE users SET nama = ? WHERE id = ?";
        return _query;
      }
    };
  ...
  @Override
  public Object updateNama(final long id, final String nama,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateNama.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfUpdateNama.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object updatePassword(final long id, final String password,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      ...
      public List<UserEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new UserEntity(_tmpId,_tmpUsername,_tmpPassword,_tmpNama,_tmpRole);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpRole;
            _tmpRole = _cursor.getString(_cursorIndexOfRole);
            _result = new UserEntity(_tmpId,_tmpUsername,_tmpPassword,_tmpNama,_tmpRole);
          } else {
            _result = null;
          }
          return _result;
